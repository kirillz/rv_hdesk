  ...
  <div class="row row-cols-2">
    <div class="col-md-9">
      <div class="panel panel-default mb-3">
        ...
        <canvas id="myChart" width="768" height="355" aria-label="Hello ARIA World" role="img"></canvas>
        {{--        </div>--}}
      </div>
    </div> {{-- /.col-md-6 --}}
    <div class="col-md-3">
            ...
            <div>
              ...
              <div class="range-label-div in-thin">
                ...
                <div class="in-bold-left in-thin"><i class="fa-solid fa-close"
                                                     style="width:38px; margin-top: 5px; padding-right:8px;"></i>Не
                  начата:
                  {{ $getTasksUnstarted }}
                </div>
                <hr class="hr-primary mt-0 mb-2">
      ...
      <div class="panel panel-default">
        <div class="panel-body revenue-panel">
          <div style="overflow: hidden;">
            ...
            <div class="in-bold">
              <div class="currency-left">0.00 ₽</div>
              <div class="currency-right">0.00 ₽</div>
            </div>
            <div class="range-label-div in-thin pull-right">
              Последние 30 дней
